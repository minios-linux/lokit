...
Options:
  ...
  -v, --version <version> Install a specific version (example: v0.9.0)
...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/minios-linux/lokit/refs/heads/master/install.sh | bash -s -- --version v0.9.0
